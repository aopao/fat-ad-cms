...
ALTER TABLE `__PREFIX__buiapi_field`
ADD COLUMN `is_byedit` tinyint(1) NULL DEFAULT 1 COMMENT '是编辑参数 0不是 1是' ,
ADD COLUMN `is_byadd`  tinyint(1) NULL DEFAULT 1 COMMENT '是添加参数 0不是 1是' ;

ALTER TABLE `__PREFIX__buiapi_table`
ADD COLUMN `command`  text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '命令';